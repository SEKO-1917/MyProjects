...
| 7.   | [time_series_project (*)](https://github.com/SEKO-1917/MyProjects/tree/main/time_series_project) | Прогнозирование количества такси у аэропорта | *python*, *pandas*, *CatBoost*, *lightgbm*, *numpy*, *statsmodels*, *seaborn*, *sklearn* |
